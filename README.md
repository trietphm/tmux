...
**Note**: Different from head project at https://github.com/dracula/tmux
Need to install `psutil` in order to get correct CPU number in MacOS (python is required).
```
pip install psutil
```
